...
public class I18n {
  ...
  private static ResourceBundle i18n = ResourceBundle.getBundle("com.ppona.plugnow.Resources");
  ...
  static protected void init (String language) {
    ...
    try {
      ...
      i18n = ResourceBundle.getBundle("com.ppona.plugnow.Resources", locale);
